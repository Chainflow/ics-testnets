...
PRIV_VALIDATOR_KEY_FILE=~/transfer/priv_validator_key.json # from provider node
NODE_KEY_FILE=~/transfer/node_key.json # from provider node
NODE_HOME=~/.isc-pepper
NODE_MONIKER=chainflow-pepper
# ***

INTERCHAIN_SECURITY_VERSION=v0.1.4
CHAIN_ID=pepper
GENESIS_FILE="https://raw.githubusercontent.com/hyphacoop/ics-testnets/main/private-testnet/ccv-pepper-genesis.json" # must include CCV states
